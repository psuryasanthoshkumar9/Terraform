...
resource "aws_secretsmanager_secret" "rds_secret" {
  ...
  description = "RDS password for admin user"
}
...
resource "aws_secretsmanager_secret_version" "rds_secret_version" {
  ...
  secret_string = jsonencode({
    username = "admin"
    password = "Admin12345"  # You can generate a random password here too
  })
}

#-----------------------
# RDS Instance (Free-tier MySQL, managed credentials)
#-----------------------
